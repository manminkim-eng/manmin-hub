...
window.MANMIN_DATA = {
  ...
  waps: [
    ...
    {no:"31",name:"열관류율",repo:"u-value-app-",ver:"5.0",disc:"건축",std:"에너지절약설계기준 국토교통부고시 제2026-360호 [2026-07-08] (실체개정 제2025-738호 [2025-12-31]) 별표1",review:"2026-09-05",status:"updated",note:"v5.0.7(2026-09-05 · sw uval-v5.0.7) 근거 고시번호 13곳 현행화 — 제2026-360호(실체개정 제2025-738호) · 별표1 U값·계산 무변경. 종전 v5.0 디자인 통일 + S10 소급(R25 SW 오염 차단·R27·R24 표선·R26) 배포 2026-09-05 · R27 클론 정화·R23② 행 나눔. 종전: Babel@7.29.7 고정·CACHE v3.2, 별표1 U값 불변"},
  ...
  changelog: [
    {date:"2026-09-05", big:true, title:"S13~S16 · 39 EPI v5.4.1 법규 감사·별지 제1호서식 정식 산정 / 00 포탈 v2.12 / 27 부하계산 v5.0.2 모바일 / 46 설계하중 v5.0.11 모달 통일", body:
      ...
      rows:[
        ...
        ["31 고시번호","제2025-738호 13곳","제2026-360호(실체개정 738호) 현행화","v5.0.7 · sw uval-v5.0.7"],
  ...
  pending: [
    ...
    "00 포탈 카드 — 39 EPI 문구 Ver5.0 → Ver5.4 갱신(별지 제1호서식 정식 산정 반영) 여부 MIN 판단(2026-09-05 보류). (31 고시번호 현행화는 v5.0.7 로 완료 · 27 은 이미 제2026-360호 표기)",
  ...
  baseline: [
    ...
    ["에너지","건축물의 에너지절약설계기준","국토부 제2026-360호(실체개정 제2025-738호)","2026-07-08 (실체 2025-12-31)","정부조직 개편 반영 재고시 · 제15조 EPI 65/공공 74점 · 제6조2호 건축1≥0.6 · 제21조② 총량제 150/130/200 · 별지 제1호서식 42항목 — 39 v5.4.1 반영 / 열관류율 별표1 U값 불변 — 31 v5.0.7 표기 현행화"],
