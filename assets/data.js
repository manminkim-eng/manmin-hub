...
window.MANMIN_DATA = {
  ...
  waps: [
    ...
    {no:"27",name:"부하계산(RTS)",repo:"Radiant-Time-Series-Method",ver:"5.0",disc:"기계",std:"ASHRAE 2009 RTS법 · 에너지절약설계기준 제2026-360호 [2026-07-08]",review:"2026-09-05",status:"updated",note:"v5.0 디자인 통일(S12) 배포 2026-09-05 · 계산 로직 무접촉(196KB 스크립트 바이트 동일) — 3단 헤더+탭 11개+요약 스트립(래핑) · 라이트 본문(계산창 포함) · 인쇄 서체·R26·R27 · SW rts-v5.0.0(R25) · manifest 아이콘 8종. 다중 시트 인쇄·헤더 버튼 6개는 운영 구조상 원형 유지(README). 종전: Ver4.0(배포본 9d78fd96 원본) 국제표준 기반, 국내법 영향 없음"},
    // 건축·행정·에너지
  ...
  pending: [
    ...
    "27 부하계산 저장소 잔재(RTS_부하계산서.html 1.3MB · index_orig.html · shortcut.html · 벤치마크_이리신광교회.rts) 삭제 여부 MIN 판단(R14). 37 저장소 생성 여부. 39 EPI v6.0 서식 재구축(§21-4).",
